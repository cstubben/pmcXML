...
# June 23 Added = for genes in collapsed tables.  Not sure why this is needed (code seems to works line by line but not in function
# July 13 added (\\b|_) for genes with subscripts sctU_Bp
  
     y <- searchP(txt, "\\b[=Δ]?[A-Za-z][a-z]{2}[A-Z0-9]+(\\b|_)", ignore.case=FALSE)
